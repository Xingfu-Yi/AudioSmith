...
Prerelease tags such as `v0.1.5-alpha.1` are marked as GitHub prereleases automatically. Do not publish `v0.1.5` as stable until the release gates are complete.
