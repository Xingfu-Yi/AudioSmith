...
5. Run `scripts/verify_release_version.sh v0.1.5`.
6. Push an annotated tag such as `v0.1.5`.
...
Tags with a suffix, such as `v0.1.5-alpha.1`, must share the numeric core with `MARKETING_VERSION` and are automatically published as GitHub prereleases. See `docs/PUBLISHING.md` for the complete source and binary readiness checklists.
